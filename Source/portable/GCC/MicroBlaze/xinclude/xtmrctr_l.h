/* $Id: xtmrctr_l.h,v 1.4 2004/03/25 13:51:58 meinelte Exp $ */
/******************************************************************************
*
...
*
* @param    BaseAddress contains the base address of the timer counter device.
* @param    TmrCtrNumber contains the specific timer counter within the device,
...
* @note     None.
*
* Xuint32 XTmrCtr_mReadReg(Xuint32 BaseAddress, Xuint8 TimerNumber,
*                          unsigned RegOffset)
******************************************************************************/
...
* @return   None
*
* void XTmrCtr_mWriteReg(Xuint32 BaseAddress, Xuint8 TimerNumber,
*                        unsigned RegOffset, Xuint32 ValueToWrite)
******************************************************************************/
...
* @note     None.
*
* void XTmrCtr_mSetControlStatusReg(Xuint32 BaseAddress, Xuint8 TmrCtrNumber,
*                                   Xuint32 RegisterValue)
*****************************************************************************/
...
* @note     None.
*
* Xuint32 XTmrCtr_mGetControlStatusReg(Xuint32 BaseAddress, Xuint8 TmrCtrNumber)
*****************************************************************************/
...
* @note     None.
*
* void XTmrCtr_mSetLoadReg(Xuint32 BaseAddress, Xuint8 TmrCtrNumber,
*                          Xuint32 RegisterValue)
*****************************************************************************/
...
* @note     None.
*
* Xuint32 XTmrCtr_mGetLoadReg(Xuint32 BaseAddress, Xuint8 TmrCtrNumber)
*****************************************************************************/
...
* @note     None.
*
* void XTmrCtr_mEnable(Xuint32 BaseAddress, Xuint8 TmrCtrNumber)
*****************************************************************************/
...
* @note     None.
*
* void XTmrCtr_mDisable(Xuint32 BaseAddress, Xuint8 TmrCtrNumber)
*****************************************************************************/
...
* @note     None.
*
* void XTmrCtr_mEnableIntr(Xuint32 BaseAddress, Xuint8 TmrCtrNumber)
*****************************************************************************/
...
* @note     None.
*
* void XTmrCtr_mDisableIntr(Xuint32 BaseAddress, Xuint8 TmrCtrNumber)
*****************************************************************************/
...
* @note     None.
*
* void XTmrCtr_mLoadTimerCounterReg(Xuint32 BaseAddress, Xuint8 TmrCtrNumber)
*****************************************************************************/
...
* @note     None.
*
* Xboolean XTmrCtr_mHasEventOccurred(Xuint32 BaseAddress, Xuint8 TmrCtrNumber)
*****************************************************************************/
