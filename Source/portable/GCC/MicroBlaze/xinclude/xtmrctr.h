/* $Id: xtmrctr.h,v 1.10 2002/05/03 17:13:57 linnj Exp $ */
/******************************************************************************
*
 ...
 *        layer when the callback is invoked. Its type is unimportant to the
 *        driver, so it is a void pointer.
 * @param TmrCtrNumber is the number of the timer/counter within the device.
 *        The device typically contains at least two timer/counters. The
 *        timer number is a zero based number with a range of 0 to
...
typedef struct
{
    Xuint32 Interrupts;      /**< The number of interrupts that have occurred */
} XTmrCtrStats;
...
XTmrCtr_Config *XTmrCtr_LookupConfig(Xuint16 DeviceId);

/*
 * Functions for options, in file xtmrctr_options.c
 */
void XTmrCtr_SetOptions(XTmrCtr *InstancePtr, Xuint8 TmrCtrNumber,
                        Xuint32 Options);
