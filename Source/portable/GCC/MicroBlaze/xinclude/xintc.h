/* $Id: xintc.h,v 1.2 2003/12/23 23:54:56 moleres Exp $ */
/******************************************************************************
*
...
* argument to the base address of the interrupting device.  Note that Level 1
* device driver interrupt handlers do not take a base address as an argument,
* but instead take a pointer to the driver instance.  This means that although
* the table is created statically, the user must still use XIntc_Connect() when
...
typedef struct
{
    ...
    Xuint32 AckBeforeService;   /**< Ack location per interrupt */
    Xuint32 Options;            /**< Device options */
...
typedef struct
{
    ...
    Xuint32 UnhandledInterrupts;/* Intc Statistics */
